...
export default function ProfileScreen() {
  ...
  function randomAvatar() {
    ...
    Animated.sequence([
      Animated.timing(avatarScale, { toValue: 0.92, duration: 120, useNativeDriver: true }),
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: themeTokens.bg }]} contentContainerStyle={[styles.content, { paddingTop: insets.top + 24 }]}>
